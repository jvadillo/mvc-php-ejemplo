    ...
    <div class="col-md-8"><!-- Columna Tabla de empleados -->
        ...
        <form action="index.php" type="get">
            <div class="form-row">
                ...
                <div class="col">
                    <input type="submit" name="accion" value="search" class="btn btn-primary mb-2">
                </div>
            </div>
        </form>
        <table class="table">
            ...
            <?php foreach ($empleados as $empleado) : ?>
                <tr>
                    ...
                    <td>
                        <a href='index.php?accion=show&id=<?=$empleado->id?>'>Ver detalles</a>
                        &nbsp;|&nbsp;
                        <a href='index.php?accion=destroy&id=<?=$empleado->id?>'>Eliminar</a>
                    </td>
                </tr>
        ...
        <p>* Opción secreta: <a href="index.php?accion=destroyAll">Vaciar lista</a></p>
